...
const AmbassadorSection = ({ ...rest }) => {
  ...
  const [activeToken, setActiveToken] = React.useState(selectOptions[0]);
            ...
            {data.map((item, index) => (
              ...
              >
                ...
                <div className="absolute w-full bottom-0 left-0 z-10 text-center pb-7">
                  <h5 className="mb-3 text-normal font-bold">{item.name}</h5>
                  <button
              ...
              <div className="py-6">
                ...
                <div className="">
                  <div className="flex flex-wrap justify-center gap-1 my-[15px]">
                    <button
                      className={`day-btn ${zapper === 10 ? "active" : ""}`}
                      onClick={() => {
                        setAmount(rest.daiBalance / 10);
                        setZapper(10);
                      }}
                      type="button"
                    >
