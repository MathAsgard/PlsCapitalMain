  ...
  if (type === "failed") {
    return (
      <div
        ...
        } min-w-[320px] max-w-[320px] flex items-stretch justify-center h-fit z-[100000]`}
      >
        <div
        ...
        <div className="w-[270px] flex items-center justify-between px-4 rounded-r-[16px] h-fit py-3 bg-[#070115]">
          ...
          <button
            ...
            className="w-6 h-6"
          >
            <img src="/img/close.png" className="w-6 h-6 cursor-pointer" />
          </button>
        </div>
      </div>
    );
    ...
    return (
      ...
      >
        ...
        <div className="w-[270px] flex items-center justify-between px-4 rounded-r-[16px] h-fit py-3 bg-[#070115]">
          ...
          <button onClick={() => toast.remove(t.id)} className="w-6 h-6">
            <img src="/img/close.png" className="w-6 h-6 cursor-pointer" />
          </button>
        </div>
      </div>
